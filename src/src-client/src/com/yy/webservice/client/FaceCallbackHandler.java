 ...
 */
    ...
    /**
     *  FaceCallbackHandler Callback class, Users can extend this class and implement
     *  their own receiveResult and receiveError methods.
     */
    public abstract class FaceCallbackHandler{
    ...
    */
    public FaceCallbackHandler(Object clientData){
     ...
     public Object getClientData() {
        return clientData;
           ...
           public void receiveResultinvoke(
                    com.edatongtu.webservice.FaceStub.InvokeResponse result
                        ) {
           }
